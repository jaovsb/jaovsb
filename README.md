# Olá, eu sou o João Victor Silva Barros! 👋

### Analista de Suporte Técnico | Desenvolvedor Full Stack
**Graduado em Análise e Desenvolvimento de Sistemas (ADS) pela PUC-GO**

Sou um desenvolvedor focado em construir sistemas robustos e de alta qualidade. Atualmente, utilizo minha base técnica no suporte para depuração de regras de negócio e identificação de bugs via análise de logs, enquanto desenvolvo aplicações modernas com foco em performance e UX.
...
* ![MaterialUI](https://img.shields.io/badge/Material%20UI-007FFF?style=for-the-badge&logo=mui&logoColor=white) **Material UI**
* **Context API**
...
* ![Kotlin](https://img.shields.io/badge/kotlin-%237F52FF.svg?style=for-the-badge&logo=kotlin&logoColor=white) **Kotlin** (iniciante)
* **RESTful APIs**
